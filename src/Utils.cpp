...
std::istream& PNG::Read(std::istream& is, std::uint8_t& i)
{
	is.read(reinterpret_cast<char*>(&i), 1);
	return is;
}	

std::istream& PNG::Read(std::istream& is, std::uint16_t& i, Endian endian)
{
	i = 0;
...
std::istream& PNG::Read(std::istream& is, std::uint32_t& i, Endian endian)
{
	i = 0;
...
std::istream& PNG::Read(std::istream& is, std::uint64_t& i, Endian endian)
{
	i = 0;
